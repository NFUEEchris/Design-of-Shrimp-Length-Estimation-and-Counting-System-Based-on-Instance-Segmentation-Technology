    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                im_masks = plot_masks(im[i], masks, mcolors)  # image with masks shape(imh,imw,3) #model size
                ...
                for mask in masks_np:
                    ...
                    try:
                        ...
                        # contour_length = cv2.arcLength(mask.astype(np.uint8), closed=True)
