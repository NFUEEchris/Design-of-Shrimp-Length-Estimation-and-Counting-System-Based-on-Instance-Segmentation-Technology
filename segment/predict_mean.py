                ...
                if len(outputs) > 0:
                    ...
                    for (*xyxy, conf, cls),output  in zip(reversed(det[:, :6]),outputs): #per bbox ,output ,outputs
                        ...
                        if str(id) not in id_dict:
                            ...
                            length_dict[str(id)]=[]
                        #============DEEPSORT========================
                        length_dict[str(id)].append(pixel2len(all_contour_length[length_count]))
                        print(id_dict)    
                        point1_A,point1_B,point2_A,point2_B,point3_A,point3_B=annotator.setline()
                        # print('cls:',cls)
                        ...
                        elif dis_B<50 and line_status_B=="right" and np.mean(length_dict[str(id)])<big and np.mean(length_dict[str(id)])>small and id_dict.get(str(id))==0:
                            print("motor_B")
                            motor="motor_B"
